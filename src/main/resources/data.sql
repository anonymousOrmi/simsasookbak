...
values ('test1@gmail.com', '김상형', '이용자', '1900-05-01', '1234', '일반', '010-1234-1234', NOW(), NOW());
...
insert into member (email, name, role, birth_date, password, status, phone, created_at, updated_at)
values ('test3@gmail.com', '송찬혁', '관리자', '1950-02-03', '123456', '일반', '010-3716-5576', NOW(), NOW());
...
insert into member (email, name, role, birth_date, password, status, phone, created_at, updated_at)
values ('test5@gmail.com', '정민석', '이용자', '1985-12-21', '12345678', '일반', '010-7324-5421', NOW(), NOW());
SET @member_id_jeong = LAST_INSERT_ID();


insert into member (email, name, role, birth_date, password, status, phone, created_at, updated_at)
values ('test6@gmail.com', '최보현', '사업자', '2000-08-01', '123456789', '일반', '010-6785-3452', NOW(), NOW());
...
values (@member_id_park, '숙소1', '숙소 설명 1', '서울', '오구구 케로로 689','08:00:00', '12:00:00', false, NOW(), NOW());
SET @accommodation_id_seoul = LAST_INSERT_ID();

insert into accommodation (member_id, name, content, region, address, check_in, check_out, is_deleted, created_at, updated_at)
values (@member_id_park, '숙소2', '숙소 설명 2', '청주','으구구 도로로 263', '10:00:00', '14:00:00', false, NOW(), NOW());
SET @accommodation_id_cheongju = LAST_INSERT_ID();

insert into accommodation (member_id, name, content, region, address, check_in, check_out, is_deleted, created_at, updated_at)
values (@member_id_choi, '숙소3', '숙소 설명 3', '대전','에그구 기로로 167', '14:00:00', '18:00:00', false, NOW(), NOW());
...
insert into room (accommodation_id, name, cost, content, use_guide, created_at, updated_at)
values (@accommodation_id_cheongju, '이-2방', 20000, '이방2이방', '창문을 닫아주세요', NOW(), NOW());
SET @room_id_two_2 = LAST_INSERT_ID();

insert into room (accommodation_id, name, cost, content, use_guide, created_at, updated_at)
values (@accommodation_id_daejeon, '삼방', 30000, '삼방삼방삼방', '창문을 닫아주세요', NOW(), NOW());
...
insert into reservation (member_id, accommodation_id, room_id, status, start_date, end_date, request, created_at, updated_at)
values (@member_id_lee, @accommodation_id_cheongju, @room_id_two_2, '완료', '2024-05-20', '2024-05-30', '이 방 제가 살게요', NOW(), NOW());
insert into reservation (member_id, accommodation_id, room_id, status, start_date, end_date, request, created_at, updated_at)
values (@member_id_lee, @accommodation_id_daejeon, @room_id_three, '대기', '2024-05-04', '2024-05-05', '잠깐 다녀갈게요', NOW(), NOW());
insert into reservation (member_id, accommodation_id, room_id, status, start_date, end_date, request, created_at, updated_at)
values (@member_id_jeong, @accommodation_id_daejeon, @room_id_three, '대기', '2024-05-05', '2024-05-06', '깨끗하게 해주세요', NOW(), NOW());
--reservation end
...
insert into review (member_id, accommodation_id, content, score, is_deleted, created_at, updated_at)
values (@member_id_lee, @accommodation_id_cheongju, '전체적으로 디자인이 좋았습니다',4,0, NOW(), NOW());
insert into review (member_id, accommodation_id, content, score, is_deleted, created_at, updated_at)
values (@member_id_lee, @accommodation_id_daejeon, '이 방 다신 예약 안합니다',1,0, NOW(), NOW());
insert into review (member_id, accommodation_id, content, score, is_deleted, created_at, updated_at)
values (@member_id_jeong, @accommodation_id_daejeon, '그냥 그랬습니다',3,0, NOW(), NOW());
